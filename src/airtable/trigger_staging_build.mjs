...
let res = await fetch('https://api.github.com/repos/yale-fortunoff/citationdb-staging/actions/workflows');
...
const dispatchRes = await fetch(`https://api.github.com/repos/yale-fortunoff/citationdb-staging/actions/workflows/${workflow.id}/dispatches`, {
  method: 'POST',
  headers: {
