...
let res = await fetch(
  "https://api.github.com/repos/yale-fortunoff/citationdb/actions/workflows",
);
...
const dispatchRes = await fetch(
  `https://api.github.com/repos/yale-fortunoff/citationdb/actions/workflows/${workflow.id}/dispatches`,
  {
    method: "POST",
    headers: {
